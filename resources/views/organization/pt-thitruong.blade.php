...
<body>
    <h1 style="text-align: center">Sơ đồ tổ chức nhân sự phòng phát triển thị trường</h1>
    <div id="wrapper">
        <div class="label-entry row" style="padding-right: 0">
            <div class="col-12"><a href="/user-t1">Trưởng phòng phát triển thị trường</a></div>
    ...
    <div class="branch lv1">
        ...
        <div class="entry">
            <div class="label-entry row" style="padding-right: 0">
                <div class="col-12"><a href="/user-t1">PT phát triển thị trường</a></div>
                <div class="col-12 row" style="margin-right: 0;padding-right: 0">
                    <div class="col-4" style="padding: 0">
                    ...
                    <p><i class="fa fa-user-plus" aria-hidden="true"></i> <i style="font-size: 8px">Mason Tuân Lương</i></p>
                    <p style="font-size: 8px;"><i class="fa fa-rss" aria-hidden="true"></i> <i>Người khai phá vùng đất phát triển</i></p>
                    <p><i class="fa fa-envelope" aria-hidden="true"></i> tuan.luong@htauto.vn</p>
                </div>
            </div>
        </div>
    </div>
    <div class="entry">
        <div class="label-entry row" style="padding-right: 0">
            <div class="col-12"><a href="/user-t1">CV PT thị trường</a></div>
            <div class="col-12 row" style="margin-right: 0;padding-right: 0">
                <div class="col-4" style="padding: 0">
                    <img src="/user-nullable.png" class="img-fluid" alt="">
                </div>
