...
<body>
    <h1 style="text-align: center">Sơ đồ tổ chức nhân sự phòng tài chính</h1>
    ...
    <div id="wrapper">
        <div class="label-entry row" style="padding-right: 0">
            <div class="col-12"><a href="/user-t1">Trưởng phòng Tài chính</a></div>
    ...
    <div class="branch lv1">
        ...
        <div class="entry sole">
            <div class="label-entry row" style="padding-right: 0">
                <div class="col-12"><a href="/user-t1">Chuyên viên Tài chính</a></div>
                <div class="col-12 row" style="margin-right: 0;padding-right: 0">
                    <div class="col-4" style="padding: 0">
                    ...
                    <div class="col-8"
                    style="font-size: 10px;text-align: left;padding-right: 0;margin-right: 0px">
                    <p><i class="fa fa-user" aria-hidden="true"></i> Phú Thị Thùy Linh</p>
                    <p><i class="fa fa-user-plus" aria-hidden="true"></i> <i style="font-size: 8px">Anna Linh Phú</i></p>
                    <p style="font-size: 8px;"><i class="fa fa-rss" aria-hidden="true"></i> <i>Chuyên viên am hiểu tài chính</i></p>
                    <p><i class="fa fa-envelope" aria-hidden="true"></i> taichinh2@htauto.com.vn</p>
                </div>
            </div>
        </div>
    </div>
