...
<body>
<h1 style="text-align: center">Sơ đồ tổ chức nhân sự phòng R&D</h1>
...
<div id="wrapper">
    <div class="label-entry row" style="padding-right: 0">
        <div class="col-12"><a href="/user-t1">Trưởng Phòng R&D</a></div>
    ...
    <div class="branch lv1">
        <div class="entry">
            <div class="label-entry row" style="padding-right: 0">
                <div class="col-12"><a href="/user-t1">Cố vấn R&D</a></div>
                <div class="col-12 row" style="margin-right: 0;padding-right: 0">
                    <div class="col-4" style="padding: 0">
        ...
        <div class="entry">
            <div class="label-entry row" style="padding-right: 0">
                <div class="col-12"><a href="#">CV Quản lý mã hàng</a></div>
                <div class="col-12 row" style="margin-right: 0;padding-right: 0">
                    <div class="col-4" style="padding: 0">
                        <img src="/0.jpg" class="img-fluid" alt="">
                    </div>
                    <div class="col-8" style="font-size: 10px;text-align: left;padding-right: 0;margin-right: 0px">
                        <p><i class="fa fa-user" aria-hidden="true"></i> Đinh Ngọc Linh</p>
                        <p><i class="fa fa-user-plus" aria-hidden="true"></i> <i style="font-size: 8px">Eulalia Linh Đinh</i></p>
                        <p style="font-size: 8px;"><i class="fa fa-rss" aria-hidden="true"></i> <i>Người am hiểu các Mã hàng</i></p>
                        <p><i class="fa fa-envelope" aria-hidden="true"></i> linh.dinh@htauto.vn</p>
                    </div>
                </div>
            </div></div>
